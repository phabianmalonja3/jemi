                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                ...
                                <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
                                    ...
                                    <p>
                                        Founded by passionate photographers,
                                        Jemigraph was born from a simple idea:
                                        combine the love for travel with the
                                        art of photography.
                                    </p>

                                    <p>
                                        Today, we continue to connect
                                        travelers, photographers and
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
                                ...
                                The passionate individuals who make our
                                photography tours extraordinary
                                ...
                                {team
                                    ...
                                    .map((member) => {
                                        ...
                                        return (
                                            ...
                                            <Card
                                                key={member.id}
                                                className="overflow-hidden flex flex-col h-full group hover:-translate-y-1 transition-all duration-300"
                                            >
                                                    ...
                                                    <div className="flex gap-4 items-center">
                                                        ...
                                                        {member.instagramUrl && (
                                                            ...
                                                            <a
                                                                ...
                                                                className="text-zinc-400 hover:text-pink-500 transition duration-300 hover:scale-110"
                                                            >
                                                        ...
                                                        {member.twitterUrl && (
                                                            ...
                                                            <a
                                                                ...
                                                                className="text-zinc-400 hover:text-blue-500 transition duration-300 hover:scale-110"
                                                            >
