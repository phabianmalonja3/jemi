...
export default function AppVersionManager() {
  ...
  const [formData, setFormData] = useState({
    ...
    storeUrl:
      "https://play.google.com/store/apps/details?id=com.jemigraph.app",
    active: true,
  });
  ...
  const handleSubmit = async (
    ...
    if (
      ...
      setErrorMessage(
        "Build numbers must be greater than 0."
      );
    ...
    if (
      formData.minimumBuildNumber >
      formData.currentBuildNumber
    ) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData((prev) => ({
          ...
          currentBuildNumber:
            prev.currentBuildNumber,

          minimumBuildNumber:
            prev.minimumBuildNumber,
      ...
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Configure application versions and
            control mandatory updates.
          </p>
        ...
        >
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-700">
              ...
              <strong>How force update works:</strong>

              {" "}

              Users with a build number below the
              Minimum Build will be forced to update.
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            >
              ...
              Set this version configuration
              as Active
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              ...
              All application version configurations
